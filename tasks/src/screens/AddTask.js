...
import {Text, Modal, View, StyleSheet, TouchableOpacity,TextInput , TouchableWithoutFeedback} from 'react-native'
        ...
        return (
            <Modal transparent={true} visible={this.props.isVisible} onRequestClose={this.props.onCancel} animationType='slide'>
                ...
                <View style={styles.container}>
                    ...
                    <TextInput style={styles.input} placeholder="Descrição..." value={this.state.desc} onChangeText={desc => this.setState({desc})}/>
